...
var _utils$constants = _olyClientSdk.utils.constants,
...
var Login = exports.Login = function (_Component) {
	...
	_createClass(Login, [{
		...
		value: function onSubmit(e) {
			e.preventDefault();
			var self = this,
			    storage = new _olyClientSdk.Storage(),
			...
			window.Oly.Auth.login(_olyClientSdk.utils.form.parse(e.target)).then(function (res) {
				if (res.hasOwnProperty('Error') && res.Error) {
					self.setState({
						errorMessage: _olyClientSdk.utils.getMessageFromOptions('onLoginFail') || res.Error.message
					});
				} else {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_olyClientSdk.utils.getTitleFromOptions('login', 'h1') || 'Login'
				),
				_react2.default.createElement(
					'form',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_olyClientSdk.utils.getTitleFromOptions('login', 'labelEmail') || 'Email',
							_react2.default.createElement(
								'supr',
								null,
								'*'
						...
						_react2.default.createElement('input', { autoComplete: 'username', name: 'olyauth.email', style: parentStyles.form.input, type: 'text', placeholder: _olyClientSdk.utils.getTitleFromOptions('login', 'placeholderEmail') || 'Email Address', onChange: this.onEmailChange, value: self.state.email })
					),
					_react2.default.createElement(
						'div',
						{ style: parentStyles.form.inputGroup },
						_react2.default.createElement(
							...
							_olyClientSdk.utils.getTitleFromOptions('login', 'labelPassword') || 'Password',
							_react2.default.createElement(
								'supr',
								null,
								'*'
						...
						_react2.default.createElement('input', { autoComplete: 'current-password', name: 'olyauth.password', style: parentStyles.form.input, type: 'password', placeholder: _olyClientSdk.utils.getTitleFromOptions('login', 'placeholderPassword') || 'Password' })
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'a',
							{ onClick: _olyClientSdk.utils.handleLinkClick, style: parentStyles.form.link, href: '/auth#slug=' + INTERFACE_CREATE_ACCOUNT },
							_olyClientSdk.utils.getTitleFromOptions('common', 'createAccount') || 'create account'
						),
						_react2.default.createElement(
							'a',
							{ onClick: _olyClientSdk.utils.handleLinkClick, style: parentStyles.form.link, href: '/auth#slug=' + INTERFACE_FORGOT_PASS },
							_olyClientSdk.utils.getTitleFromOptions('common', 'forgotPassword') || 'forgot password?'
						)
					),
					_react2.default.createElement(
						'p',
						...
						_olyClientSdk.utils.getTitleFromOptions('common', 'required') || 'required'
					),
					_react2.default.createElement(
						'p',
					...
					_react2.default.createElement(
						...
						_olyClientSdk.utils.getTitleFromOptions('login', 'submit') || 'Submit'
					),
