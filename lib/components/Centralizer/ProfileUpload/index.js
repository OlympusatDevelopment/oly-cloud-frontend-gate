      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', { id: 'olyauth.file', name: 'olyauth.file', type: 'file', multiple: true, accept: 'image/*', style: _styles2.default.fileInput, onChange: this.onFileChange }),
            React.createElement(
              'p',
              { style: _styles2.default.filename },
              this.state.filename
            ),
            React.createElement('input', { style: this.state.uploadButton, type: 'submit', value: 'Upload' })
          )
        )
      );
    }
